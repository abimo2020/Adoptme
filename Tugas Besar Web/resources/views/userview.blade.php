      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo"><a href="{{asset('index.html')}}"><img src="images/logo.png"></a></div>
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="banner_taital">
                              ...
                              <h1 class="coffee_text">AdoptMe</h1>
                              <p class="there_text">Mari membantu kucing dan anjing untuk menemukan rumahnya, sebuah tempat yang nyaman dan aman bagi mereka.</p>
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="banner_taital">
                              <h1 class="outstanding_text">Outstanding </h1>
                              <h1 class="coffee_text">AdoptMe</h1>
                              <p class="there_text">AdoptMe hadir untuk menjembatani anda pecinta hewan dengan kucing dan anjing yang telah kami kumpulkan datanya pada website ini </p>
                              <div class="learnmore_bt"><a href="#">Learn More</a></div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="banner_taital">
                              <h1 class="outstanding_text">Outstanding </h1>
                              <h1 class="coffee_text">AdoptMe</h1>
                              <p class="there_text">Jika anda menemukan seekor kucing atau anjing di jalanan, anda dapat memasukkan datanya agar mereka dapat bertemu dengan seseorang yang ingin merawatnya. </p>
                              <div class="learnmore_bt"><a href="#">Learn More</a></div>
                           </div>
                        </div>
                     </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="about_taital_main">
                     ...
                     <p class="about_text">Kami membantu kucing dan anjing untuk dapat .</p>
